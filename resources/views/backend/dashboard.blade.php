...
@section('content')
    ...
    <div class="container-fluid mt--7">
        ...
        <div class="row mt-5">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <x-progress-bar value="60" bg="gradient-danger"/>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <x-progress-bar value="70" bg="gradient-success"/>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <x-progress-bar value="80" bg="gradient-primary"/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <x-progress-bar value="75" bg="gradient-info"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <x-progress-bar value="30" bg="gradient-warning"/>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
            ...
            <div class="col-12 mt-1 mb-5 bg-gradient-dark p-5">
                <h3 class="text-white mb-5">Slider Examples</h3>
                <x-form.slider />
                <x-form.slider name="lk" min="4" max="90" />
                <x-form.range-slider />
                <x-form.range-slider name="dd"  min="200" max="270" value-min="222" value-max="250"/>
            </div>
